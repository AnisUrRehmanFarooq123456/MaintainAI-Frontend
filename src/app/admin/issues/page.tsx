...
export default function AdminIssuesPage() {
  ...
  const technicianFilter = searchParams.get("assignedTechnician") || "";
  ...
  const loadIssues = async () => {
    ...
    try {
      ...
      if (technicianFilter)
        params.append("assignedTechnician", technicianFilter);
        ...
        <div className="issues-table-wrap">
          <table className="issues-table">
            ...
            <tbody>
              {issues.length === 0 && (
                <tr>
                  <td colSpan={10} className="issues-empty">
                    No issues found
                  </td>
                </tr>
              )}
